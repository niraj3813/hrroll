        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "HRRoll Verification Code",
                        $"Your 8-digit verification code is <strong>{code}</strong>. This code will expire in 1 minute.");
